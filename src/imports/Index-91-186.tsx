...
function Group() {
  return (
    <div className="absolute contents left-[57px] top-[193px]" data-name="Group">
      <div className="absolute font-['Noto_Sans_TC:Bold',_sans-serif] leading-[0] left-[196.5px] not-italic text-[#605f5f] text-[20px] text-center text-nowrap top-[325px] tracking-[1px] translate-x-[-50%] uppercase">
        <p className="leading-[normal] whitespace-pre">設定目標，獲得獎勵！</p>
      </div>
      <div className="absolute bg-center bg-cover bg-no-repeat h-[114px] left-[57px] top-[193px] w-[279px]" data-name="image 6" style={{ backgroundImage: `url('${imgImage6}')` }} />
    </div>
  );
}
